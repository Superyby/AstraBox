...
# Enable the server when using releases (PHX_SERVER=true bin/astrabox start)
if System.get_env("PHX_SERVER") do
  config :astrabox, AstraboxWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :astrabox, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
